...
<template>
  <div id="container">
    ...
    <div id="NavBar" class="w-full h-16 bg-violet-900 flex justify-center items-center text-white font-semibold text-2xl font-mono px-3 md:px-60 ">
  ...
  <!-- MOBILE -->
    <div id="mySidenav" class="fixed w-0 top-0 right-0 overflow-x-hidden pt-16 duration-150 z-50  bg-violet-200 shadow-md h-full md:hidden">
      <div class="flex w-full justify-start ml-5">
        <a class="p-2 block duration-75 h-10 w-10  text-4xl z-20" @click="closeNav()">&times;</a>
      </div>
      <div class="flex justify-end w-full">
      <ul class="menu pt-4 w-2/3 text-violet-900 font-semibold text-xl">
        <li><a class="p-2 pr-6 duration-75 w-full rounded-l-lg flex justify-end" href="#">Login</a></li>
      </ul>
      </div>
    </div>
    <div class="md:hidden">
        <div id="content" class="w-full">
          ...
          <div id="Forms">
            <div id="CaloriesForm">
              <h3 class="w-full text-center text-lg font-semibold mt-6">Add Calories</h3>
              <p class="text-center">Write down what you eat to keep track of your calories</p>
              <div class="w-full justify-center flex flex-wrap gap-2 mt-3">
                <input type="text" required placeholder="Name of food" class="border w-48 p-1 px-3" />
                <input type="time" required id="currentTime" v-model="time"  class="border w-48 p-1 px-3" />
                <input type="text" required placeholder="Calories per 100 g/ml" class="border w-48 p-1 px-3" />
                <input type="text" required placeholder="Amount per grams" class="border w-48 p-1 px-3" />
                <button class="mb-4 p-2 bg-violet-900 text-violet-200 px-10 font-semibold rounded-md max-h-10 duration-150 active:scale-110 active:bg-violet-200 active:text-violet-900">ADD</button>
              </div>
            </div>
            <div id="CurrentWeight">
              <h3 class="w-full text-center text-lg font-semibold mt-3">Add current weight</h3>
              <p class="text-center">Add your weight to get relevant Facts</p>
              <div class="w-full justify-center flex flex-wrap gap-2 mt-3">
                <input type="date" v-model="date"  class="border w-48 p-1 px-3" />
                <input type="text" placeholder="Current weight" class="border w-48 p-1 px-3 " />
                <button class="mb-4 p-2 bg-violet-900 text-violet-200 px-10 font-semibold rounded-md max-h-10 duration-150 active:scale-110 active:bg-violet-200 active:text-violet-900">ADD</button>
              </div>
            </div>
          </div>
          <div id="Facts" class="flex flex-wrap max-w-5xl w-full p-6 gap-3 justify-center">
            <h1 class="w-full text-center text-3xl">Facts</h1>
            <div id="tile1" class="border w-44 p-3 py-4 ">
              <h1 class="w-full text-center text-bold text-xl">Remaning Calories</h1>
            ...
            <div id="tile2" class="border w-44 py-4">
              ...
              <p class="w-full text-center my-3 text-bold text-2xl">{number} KG</p>
  ...
  <!-- DESKTOP -->
    <div id="ToolBar" class="md:grid hidden justify-between w-full grid-cols-11 grid-rows-1 auto-cols-max"> 

        <div id="content" class="w-full p-10 col-span-9 justify-center flex flex-wrap">
          ...
          <div class="w-48 h-full bg-violet-200 ">
            <div class="flex justify-end py-5">
              <ul class="pt-4 w-2/3 text-violet-900 font-semibold text-xl">
                <li><a class="p-2 pr-6  w-full rounded-l-lg flex justify-end bg-violet-300 duration-200 active:scale-90 active:bg-violet-900 active:text-violet-200" href="#">Login</a></li>
              </ul>
            </div>
          </div>
        </div>
